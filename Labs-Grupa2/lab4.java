...
Функцијата треба да ја измине листата и да го отстрани N-тиот јазол од крајот на листата. Задачата да се реши и со класата SLinkedList
и со класата LinkedList.
 */
class Node<E> {
    protected E data;
